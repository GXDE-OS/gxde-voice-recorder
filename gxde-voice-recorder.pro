...
isEmpty(DSRDIR):DSRDIR=/usr/share/gxde-voice-recorder
isEmpty(DOCDIR):DOCDIR=/usr/share/dman/gxde-voice-recorder
...
icon.files = image/gxde-voice-recorder.svg
desktop.files = gxde-voice-recorder.desktop
manual.files = manual/*
